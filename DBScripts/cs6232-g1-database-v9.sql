USE [master]
GO
/****** Object:  Database [cs6232-g1]    Script Date: 4/7/2024 10:39:04 PM ******/
...
USE [cs6232-g1]
GO
/****** Object:  Table [dbo].[Categories]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Furniture]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Members]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentalLineItems]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentalTransactions]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ReturnLineItems]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ReturnTransactions]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Styles]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (1, N'Blue Modern Chair', N'Blue Modern Chair', 30, 14, 0.2500, N'Chair', N'Modern')
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (2, N'Red Modern Chair', N'Red Modern Chair', 30, 8, 0.2500, N'Chair', N'Modern')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (4, N'Brown Mission Chair', N'Brown Mission Chair', 30, 4, 0.2500, N'Chair', N'Mission')
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (5, N'Oak Shaker Chair', N'Oak Shaker Chair', 30, 3, 0.2500, N'Chair', N'Shaker')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (7, N'6 Person Table', N'6 Person Table', 30, 1, 2.1000, N'Table', N'Modern')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (15, N'Large Oak Wardrobe', N'Large Oak Wardrobe', 30, 2, 2.3000, N'Wardrobe', N'Contemporary')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (17, N'Small Oak Wardrobe', N'Small Oak Wardrobe', 30, 1, 2.5000, N'Wardrobe', N'Contemporary')
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (18, N'Twin Bed', N'Basic Twin Bed', 30, 2, 1.0000, N'Bed', N'Modern')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (21, N'King Bed', N'Basic King Bed', 30, 1, 1.7500, N'Bed', N'Modern')
...
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (25, N'Mahogany Night Stand', N'description', 30, 2, 0.5000, N'Night Stand', N'Scandinavian')
INSERT [dbo].[Furniture] ([FurnitureID], [Name], [Description], [QuantityOwned], [QuantityRented], [DailyRentalRate], [Category], [Style]) VALUES (26, N'Plain Stand', N'description', 30, 2, 0.2500, N'Night Stand', N'Modern')
...
GO
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (7, 1, 6, 0, 0.2500)
...
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (8, 21, 1, 0, 1.7500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (8, 25, 2, 0, 0.5000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (9, 4, 4, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (9, 18, 2, 0, 1.0000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (10, 2, 6, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (10, 7, 1, 0, 2.1000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (10, 17, 1, 0, 2.5000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (10, 23, 1, 0, 2.5000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (10, 26, 2, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (11, 2, 2, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (11, 6, 1, 0, 2.0000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (11, 15, 2, 0, 2.3000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (12, 6, 2, 0, 2.0000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (13, 1, 8, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (13, 6, 4, 0, 2.0000)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (14, 5, 1, 0, 0.2500)
INSERT [dbo].[RentalLineItems] ([RentalID], [FurnitureID], [QuantityRented], [QuantityReturned], [Cost]) VALUES (15, 5, 1, 0, 0.2500)
...
INSERT [dbo].[RentalTransactions] ([RentalID], [DateRented], [DateDue], [EmployeeID], [MemberID]) VALUES (13, CAST(N'2024-04-07T00:31:20.467' AS DateTime), CAST(N'2024-04-09T23:59:59.000' AS DateTime), 2, 2)
...
GO
/****** Object:  StoredProcedure [dbo].[getMostPopularFurnitureDuringDates]    Script Date: 4/7/2024 10:39:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
