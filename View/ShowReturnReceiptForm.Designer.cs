...
{
    partial class ShowReturnReceiptForm
    {
        /// <summary>
        ...
        {
            ShowReturnReceiptTableLayoutPanel = new TableLayoutPanel();
            ShowReturnReceiptEmployeeIDTextBox = new TextBox();
            ShowReturnReceiptMemberIDTextBox = new TextBox();
            ShowReturnReceiptListView = new ListView();
            ShowReturnReceiptRentalIDColumnHeader = new ColumnHeader();
            ShowReturnReceiptFurnitureIDColumnHeader = new ColumnHeader();
            ShowReturnReceiptNameColumnHeader = new ColumnHeader();
            ShowReturnReceiptDescriptionColumnHeader = new ColumnHeader();
            ShowReturnReceiptDailyRateColumnHeader = new ColumnHeader();
            ShowReturnReceiptQuantityReturnedColumnHeader = new ColumnHeader();
            ShowReturnReceiptCostColumnHeader = new ColumnHeader();
            ShowReturnReceiptRentalIDLabel = new Label();
            ShowReturnReceiptMemberIDLabel = new Label();
            ShowReturnReceiptEmployeeIDLabel = new Label();
            ShowReturnReceiptDateReturnedLabel = new Label();
            ShowReturnReceiptRentalIDTextBox = new TextBox();
            ShowReturnReceiptReturnDateDateTimePicker = new DateTimePicker();
            ShowReturnReceiptQuantityLabel = new Label();
            ShowReturnReceiptTotalCostLabel = new Label();
            ...
            SuspendLayout();
            // 
            // ShowReturnReceiptTableLayoutPanel
            // 
            ShowReturnReceiptTableLayoutPanel.ColumnCount = 8;
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ...
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 12.5F));
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptEmployeeIDTextBox, 5, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptMemberIDTextBox, 3, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptListView, 0, 1);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptRentalIDLabel, 0, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptMemberIDLabel, 2, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptEmployeeIDLabel, 4, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptDateReturnedLabel, 6, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptRentalIDTextBox, 1, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptReturnDateDateTimePicker, 7, 0);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptQuantityLabel, 4, 2);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptTotalCostLabel, 6, 2);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptQuantityTextBox, 5, 2);
            ShowReturnReceiptTableLayoutPanel.Controls.Add(ShowReturnReceiptTotalCostTextBox, 7, 2);
            ...
            // 
            // ShowReturnReceiptRentalIDColumnHeader
            // 
            ShowReturnReceiptRentalIDColumnHeader.Text = "Rental ID";
            // 
            // ShowReturnReceiptFurnitureIDColumnHeader
            // 
            ShowReturnReceiptFurnitureIDColumnHeader.Text = "Furniture ID";
            // 
            // ShowReturnReceiptNameColumnHeader
            // 
            ShowReturnReceiptNameColumnHeader.Text = "Name";
            // 
            // ShowReturnReceiptDescriptionColumnHeader
            // 
            ShowReturnReceiptDescriptionColumnHeader.Text = "Description";
            // 
            // ShowReturnReceiptDailyRateColumnHeader
            // 
            ShowReturnReceiptDailyRateColumnHeader.Text = "Daily Rate";
            // 
            // ShowReturnReceiptQuantityReturnedColumnHeader
            // 
            ShowReturnReceiptQuantityReturnedColumnHeader.Text = "Quantity Returned";
            // 
            // ShowReturnReceiptCostColumnHeader
            // 
            ShowReturnReceiptCostColumnHeader.Text = "Cost";
            // 
            // ShowReturnReceiptRentalIDLabel
            // 
            ...
            // 
            // ShowReturnReceiptMemberIDLabel
            // 
            ...
            // 
            // ShowReturnReceiptEmployeeIDLabel
            // 
            ...
            // 
            // ShowReturnReceiptDateReturnedLabel
            // 
            ...
            // 
            // ShowReturnReceiptTotalCostLabel
            // 
            ...
            Text = "ShowReturnReceiptForm";
            ShowReturnReceiptTableLayoutPanel.ResumeLayout(false);
            ShowReturnReceiptTableLayoutPanel.PerformLayout();
            ResumeLayout(false);
        }

        #endregion

        private TableLayoutPanel ShowReturnReceiptTableLayoutPanel;
        private TextBox ShowReturnReceiptEmployeeIDTextBox;
        private TextBox ShowReturnReceiptMemberIDTextBox;
        private ListView ShowReturnReceiptListView;
        private ColumnHeader ShowReturnReceiptRentalIDColumnHeader;
        private ColumnHeader ShowReturnReceiptFurnitureIDColumnHeader;
        private ColumnHeader ShowReturnReceiptNameColumnHeader;
        private ColumnHeader ShowReturnReceiptDescriptionColumnHeader;
        private ColumnHeader ShowReturnReceiptDailyRateColumnHeader;
        private ColumnHeader ShowReturnReceiptQuantityReturnedColumnHeader;
        private ColumnHeader ShowReturnReceiptCostColumnHeader;
        private Label ShowReturnReceiptRentalIDLabel;
        private Label ShowReturnReceiptMemberIDLabel;
        private Label ShowReturnReceiptEmployeeIDLabel;
        private Label ShowReturnReceiptDateReturnedLabel;
        private TextBox ShowReturnReceiptRentalIDTextBox;
        private DateTimePicker ShowReturnReceiptReturnDateDateTimePicker;
        private Button ShowReturnReceiptCloseButton;
        private Label ShowReturnReceiptQuantityLabel;
